    ...
    extends SimpleTest
{
    ...
    String SPONGY_CASTLE_PROVIDER_NAME = "SC";
        ...
        try
        {
            PGPSecretKey pgpChangedKey = PGPSecretKey.copyWithNewPassword(pgpSecKey,
                new JcePBESecretKeyDecryptorBuilder(
                    new JcaPGPDigestCalculatorProviderBuilder().setProvider(SPONGY_CASTLE_PROVIDER_NAME).build()).setProvider(SPONGY_CASTLE_PROVIDER_NAME).build(pgpOldPass.toCharArray()),
